...
- التوصيل: حي الزهور وحي السلام (من فرع الزهور)، وحي أحد وحي بدر (من فرع أحد) — رسوم التوصيل 5 ريال لكل الأحياء
...
- عرض التوصيل المجاني 🎉: إذا كانت قيمة الأصناف 50 ريال أو أكثر، التوصيل مجاني
- الحد الأدنى للطلب: 25 ريال
...
وجبات أخرى: وجبة صاروخ=19 | وجبة جامبو=19 | وجبة عربي مفرد=22 | وجبة عربي دبل=34 | وجبة عائلية 10 شاورما=85 | وجبة عائلية 15 شاورما=118 | وجبة بروستد 4قطع=22 | وجبة بروستد 8قطع=38
جانبيات: بطاطس صغير=5 | بطاطس كبير=10 | بروستد 4قطع=19 | بروستد 8قطع=36 (البروستد بنكهة عادي أو سبايسي، نفس السعر) | ثوم=2 | سبايسي=2 | حمص=7
...
5. العروض الحالية هي فقط: (أ) التوصيل مجاني للطلبات التي قيمة أصنافها 50 ريال أو أكثر، (ب) مكافأة الولاء: بعد كل 4 طلبات، الطلب الخامس توصيله مجاني. لا تخترع أبداً أي عرض أو خصم أو كوبون أو تخفيض أو سعر غير المذكور في هذه المعلومات. إذا سأل العميل عن أي عرض أو خصم آخر، قل بوضوح: "ما عندنا عروض ثانية حالياً 🌯 — بس التوصيل مجاني للطلبات 50 ريال فأكثر" """
...
FREE_DELIVERY_MIN = 50  # items subtotal >= this (SAR) → delivery is free
